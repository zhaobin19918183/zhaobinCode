...
class SectionHeaderView: UITableViewHeaderFooterView {
    ...
    override func awakeFromNib() {
        ...
        self.disclosureButton.setImage(UIImage(named: "carat-open"), for: UIControlState.selected)
    ...
    func toggleOpenWithUserAction(_ userAction: Bool) {
        ...
        if userAction {
            if self.disclosureButton.isSelected {
                if self.delegate.responds(to: #selector(BusTableViewController.sectionHeaderView(_:sectionClosed:))) {
