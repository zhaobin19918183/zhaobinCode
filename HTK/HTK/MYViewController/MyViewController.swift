...
class MyViewController: UITableViewController,SectionHeaderViewDelegate{
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if cell.longPressRecognizer == nil {
            let longPressRecognizer: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(MyViewController.handleLongPress(_:)))
    ...
    func handleLongPress(longPressRecognizer: UILongPressGestureRecognizer) {
        ...
        if longPressRecognizer.state == UIGestureRecognizerState.Began {
            ...
            if pressedIndexPath != nil && pressedIndexPath?.row != NSNotFound && pressedIndexPath?.section != NSNotFound {
                ...
                let menuItem: EmailMenuItem = EmailMenuItem(title: title, action: #selector(MyViewController.emailMenuButtonPressed(_:)))
